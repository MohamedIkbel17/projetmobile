...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    CustomAdapter(Context context, ArrayList patient_id, ArrayList patient_nom, ArrayList patient_prenom, ArrayList patient_maladie) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (updatedPosition != RecyclerView.NO_POSITION) {
                    ...
                    intent.putExtra("id", String.valueOf(patient_id.get(updatedPosition)));
                    intent.putExtra("nom", String.valueOf(patient_nom.get(updatedPosition)));
                    intent.putExtra("prenom", String.valueOf(patient_prenom.get(updatedPosition)));
                    intent.putExtra("maladie", String.valueOf(patient_maladie.get(updatedPosition)));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            patient_prenom_txt = itemView.findViewById(R.id.patient_prenommm);
